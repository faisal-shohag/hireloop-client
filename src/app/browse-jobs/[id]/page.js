    ...
    return (
      <div className="min-h-[60vh] max-w-7xl mx-auto flex items-center justify-center text-zinc-500 dark:text-zinc-400">
        <p className="text-sm font-medium">
          Job position details could not be found.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen max-w-7xl mx-auto  dark:bg-zinc-950 p-4 sm:p-6 md:p-8 space-y-6 transition-colors duration-300">
      ...
      <div className="w-full bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-5">
          ...
          <div className="flex items-center gap-3 self-end sm:self-center shrink-0 w-full sm:w-auto">
            <Button className={"h-10 w-10"} variant="outline" size="sm">
              <Bookmark className="size-4" />
            </Button>
            <JobApply jobId={job._id}/>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          return (
            <div
              key={idx}
              className="bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-4 flex flex-col justify-between min-h-23.75 shadow-sm"
            >
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="w-full lg:w-90 bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800/80 rounded-2xl p-6 shadow-sm space-y-5 shrink-0">
          ...
          <div className="space-y-3 text-xs sm:text-sm">
            <div className="flex justify-between items-center py-0.5">
              <span className="font-medium text-zinc-400 uppercase text-[10px] tracking-wider">
                Size Range
              </span>
            ...
            <div className="flex justify-between items-center py-0.5 border-t border-zinc-100 dark:border-zinc-800/50 pt-3">
              ...
              <span className="font-bold text-zinc-800 dark:text-zinc-200 truncate max-w-45 text-right block">
